...
public class CopyOnWriteWeakReferenceList<E> extends AbstractList<E> {
        ...
        public static void main(String[] args) {
			CopyOnWriteWeakReferenceList<String> list = new CopyOnWriteWeakReferenceList<String>();
			list.add("1331");
			list.add("1332");
			list.add("1333");
			list.add("1335");
